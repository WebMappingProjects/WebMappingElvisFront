const EcolesMatPrimairePointForm = ()  => {
    return (
        <div className="relative flex-auto px-4 py-10 rounded shadow lg:px-10 bg-neutral-200">
            <h1 className="text-lg font-bold text-center text-primary-default md:text-2xl">Ecoles maternelles et primaires</h1>
            <div className="mt-4 mb-3 text-center text-primary-dark">
                Veuillez specifier les informations pour l&apos;ecole maternelle ou primaire
            </div>
            <form>
...
export default EcolesMatPrimairePointForm;