...
const EnseignementsTable = () => {
    ...
    const headRow = [ "N°", "Nom de l'établissement", "Nom du responsable", "Effectif", "Type d'établissement", "Type de religion", "Type d'enseignement", "Type de formation", "Meilleur diplôme", "Commune", "Département", "Région" ];
...
export default EnseignementsTable;