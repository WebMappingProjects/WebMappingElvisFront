...
const HotelsPointTable = () => {
    ...
    const headRow = [ "N°", "Nom", "Carte postale", "Téléphone", "Quartier",  "Commune", "Restaurants", "Piscines", "Appartements", "Chambres", "Conferences", "Night club", "Suites", "Bars", "Golf", "Standing", "Tenis" ];
